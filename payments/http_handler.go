...
func (h *PaymentHTTPHandler) handleCheckoutWebhook(w http.ResponseWriter, r *http.Request) {
	...
	event, err := webhook.ConstructEventWithOptions(body, r.Header.Get("Stripe-Signature"), endpointStripeSecret, webhook.ConstructEventOptions{IgnoreAPIVersionMismatch: true})
