...
type CreaetOrderRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CreaetOrderRequest) Reset() {
	*x = CreaetOrderRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreaetOrderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreaetOrderRequest) ProtoMessage() {}

func (x *CreaetOrderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_oms_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreaetOrderRequest.ProtoReflect.Descriptor instead.
func (*CreaetOrderRequest) Descriptor() ([]byte, []int) {
	return file_api_oms_proto_rawDescGZIP(), []int{3}
}

func (x *CreaetOrderRequest) GetCustomerID() string {
	if x != nil {
		return x.CustomerID
	}
	return ""
...
func (x *CreaetOrderRequest) GetItems() []*ItemsWithQuantity {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_api_oms_proto_rawDesc = []byte{
	...
	0x61, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x05, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x32, 0x43, 0x0a,
	0x0d, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x69, 0x76, 0x69, 0x63, 0x65, 0x12, 0x32,
	0x0a, 0x0b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x17, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0a, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x42, 0x20, 0x5a, 0x1e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x72, 0x69, 0x6b, 0x75, 0x67, 0x68, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73,
...
var file_api_oms_proto_goTypes = []interface{}{
	...
	(*CreaetOrderRequest)(nil), // 3: api.CreaetOrderRequest
}
var file_api_oms_proto_depIdxs = []int32{
	1, // 0: api.Order.Items:type_name -> api.Item
	2, // 1: api.CreaetOrderRequest.Items:type_name -> api.ItemsWithQuantity
	3, // 2: api.OrderSerivice.CreateOrder:input_type -> api.CreaetOrderRequest
	0, // 3: api.OrderSerivice.CreateOrder:output_type -> api.Order
...
func file_api_oms_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_oms_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreaetOrderRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
